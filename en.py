...
def button_settings():
    ...
    set_languages['values'] = ('English', 'Deutsch', 'Español', 'Français', 'Italiano', 'Polski', 'Suomi', 'Русский', 'Беларуская', 'Ελληνικά', 'Հայերեն', 'עִבְרִית', 'اَلْعَرَبِيَّةُ', '中文', '日本語')  
...
input_languages['values'] = ('Arabic', 'Armenian', 'Belarusian', 'Chinese', 'English', 'Finnish', 'French', 'German', 'Greek', 'Hebrew', 'Italian', 'Japanese', 'Polish', 'Russian', 'Spanish')    
input_languages.current(4)
input_languages.place(x = 125, y = 25, width = 100, height = 25)
...
translate_label.place(x = 500, y = 25, width = 85, height = 25)
translate_languages = Combobox(window)
translate_languages['values'] = ('Arabic', 'Armenian', 'Belarusian', 'Chinese', 'English', 'Finnish', 'French', 'German', 'Greek', 'Hebrew', 'Italian', 'Japanese', 'Polish', 'Russian', 'Spanish')    
translate_languages.current(14)
translate_languages.place(x = 585, y = 25, width = 100, height = 25)
